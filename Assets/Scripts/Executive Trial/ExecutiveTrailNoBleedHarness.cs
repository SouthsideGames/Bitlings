...
/// <summary>
/// Dev-only invariant harness: detects persistent "bleed" into the main save while Executive Trial is active.
/// 
/// IMPORTANT:
...
/// </summary>
public static class ExecutiveTrailNoBleedHarness
{
    ...
    public static void AssertUnchanged(string context)
    {
        ...
        Debug.LogError(
            "[ExecutiveTrailNoBleedHarness] SAVE BLEED DETECTED during Executive Trial. " +
