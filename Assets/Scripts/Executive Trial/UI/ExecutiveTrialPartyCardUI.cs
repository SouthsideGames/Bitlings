...
/// <summary>
/// Individual party member card for the Executive Trial Replace panel.
/// Has its own prefab and layout, separate from ExecutiveTrialMonsterCardUI.
/// Designed to be tapped to select a party member for dismissal.
/// </summary>
public sealed class ExecutiveTrialPartyCardUI : MonoBehaviour
{
    [Header("Core")]
