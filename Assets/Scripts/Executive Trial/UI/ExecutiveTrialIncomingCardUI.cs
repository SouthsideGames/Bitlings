...
/// <summary>
/// Individual incoming recruit card for the Executive Trial Replace panel.
/// Uses its own prefab/layout and binds offer data directly.
/// </summary>
public sealed class ExecutiveTrialIncomingCardUI : MonoBehaviour
{
    [Header("Core")]
    ...
    public void Bind(ExecutiveTrailMonster offer)
    {
