...
public sealed class ExecutiveTrailTitleRoller
{
    [Header("Policy")]
    ...
    public TitleSO RollLockedTitle(MonsterDataSO def, int level, ExecutiveTrailRngStream rng, bool isWild)
    {
    ...
    public TitleSO RollExecutiveTrailTitle(MonsterDataSO def, int level, ExecutiveTrailRngStream rng, bool isWild)
    {
        if (def == null) return null;
    ...
    private static TitleSO PickFromArray(TitleSO[] arr, ExecutiveTrailRngStream rng)
    {
