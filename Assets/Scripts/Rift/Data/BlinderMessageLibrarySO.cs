...
public class BlinderMessageLibrarySO : ScriptableObject
{
    ...
    /// </summary>
    public string GetWeightedRandomLine(string langCode, string hardFallback = "I WONDER WHAT WE WILL RIFT", string lastLine = null)
    {
    ...
    /// Returns hardFallback if no entry available.
    /// </summary>
    public string GetWeightedRandomLine(BlinderMessagePackSO pack, string hardFallback = "I WONDER WHAT WE WILL RIFT", string lastLine = null)
    {
