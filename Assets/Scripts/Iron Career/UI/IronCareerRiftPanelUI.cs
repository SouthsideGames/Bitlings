...
public sealed class IronCareerRiftPanelUI : MonoBehaviour
{
    public static IronCareerRiftPanelUI I { get; private set; }
    ...
    public void ShowStarter(bool immediate = false)
    {
        ...
        if (!starter)
            Debug.LogError("[IronCareerRiftPanelUI] Starter CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowHire(bool immediate = false)
    {
        ...
        if (!hire)
            Debug.LogError("[IronCareerRiftPanelUI] Hire CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowReplace(bool immediate = false)
    {
        ...
        if (!replace)
            Debug.LogError("[IronCareerRiftPanelUI] Replace CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowPost(bool immediate = false)
    {
        ...
        if (!post)
            Debug.LogError("[IronCareerRiftPanelUI] Post CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowForcedEvolve(bool immediate = false)
    {
        ...
        if (!forcedEvolve)
            Debug.LogError("[IronCareerRiftPanelUI] ForcedEvolve CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowRest(bool immediate = false)
    {
        ...
        if (!rest)
            Debug.LogError("[IronCareerRiftPanelUI] Rest CanvasGroup missing. Panel will appear blank.");
    }
    ...
    public void ShowGameOver(bool immediate = false)
    {
        ...
        if (!gameOver)
            Debug.LogError("[IronCareerRiftPanelUI] GameOver CanvasGroup missing. Panel will appear blank.");
    }
    ...
    private CanvasGroup FindCg(string name)
    {
        ...
        if (!cg)
            Debug.LogWarning($"[IronCareerRiftPanelUI] Missing CanvasGroup on '{tr.name}'. Add one in prefab/scene for fade/control.", tr);
        return cg;
    }
