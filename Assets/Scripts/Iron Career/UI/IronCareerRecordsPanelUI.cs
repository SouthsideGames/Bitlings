...
public sealed class IronCareerRecordsPanelUI : MonoBehaviour
{
    ...
    public void Refresh()
    {
        var data = IronCareerStats.Load();
        var month = IronCareerStats.GetCurrentMonthRecord();
        ...
        if (titleTMP) titleTMP.text = "IRON CAREER RECORDS";
