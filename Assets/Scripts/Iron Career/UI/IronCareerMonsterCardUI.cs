...
/// <summary>
/// Reusable monster card view for Iron Career UI.
...
/// </summary>
public sealed class IronCareerMonsterCardUI : MonoBehaviour
{
    [Header("Core")]
    ...
    public void Bind(IronMonster monster, bool isLocked, bool isSelectable)
    {
