...
public sealed class IronRunTimelineUI : MonoBehaviour
{
    ...
    public void Bind(List<IronBattleLogEntry> log, bool forfeited, IronCareerRunState.IronCareerMode mode)
    {
        ...
        // Personal best check
        var stats = IronCareerStats.Load();
        int best = mode == IronCareerRunState.IronCareerMode.Hardcore
