...
/// </summary>
public sealed class IronCareerEligibleEvolutionItemUI : MonoBehaviour
{
    [Header("UI")]
    ...
    public void Bind(int partyIndex, IronMonster monster, MonsterDataSO evolveTo, Action onClick)
    {
